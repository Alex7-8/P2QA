...
{
    public class IngresarCredencialesIncorrectas
    {
        [Fact]
        public void CredencialesIncorrectas()
        {
            ...
            try
            {
                ...
                string User = "standard_users";
                string Pass = "secret_sauces";
                ...
                Assert.Equal("Epic sadface: Username and password do not match any user in this service", textoDelElemento);
